...
public class CountCodeLines {  
    ...
    //将要统计的java类放在某个文件夹内  可包含子目录  例如下：
    private static String filePath = "D:\\CHP_Workspace\\chp-loan\\src\\main\\java";
    public static void main(String[] args) throws IOException{  
        ...
        System.out.println("总java文件数：" + fileNumber);  
    }  
