...
$(document).ready(function(){
	...
	$("#daoBtn").click(function(){
		...
		window.location.href=ctx+"/channel/goldcredit/grantDone/grantDoneExl?"+$("#grantForm").serialize()+"&idVal="+idVal;
	});
	var $checkBoxItem = $(":input[name='checkBoxItem']");
	var num = 0,money = 0.00;
	var hiddenTotalNum = parseFloat($("#hiddenTotalNum").val());
