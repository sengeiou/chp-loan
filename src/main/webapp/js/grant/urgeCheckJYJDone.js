...
$(document).ready(function(){
	...
	$('#daoBtn').bind('click', function() {
		...
		window.location.href=ctx+"/urgeCheckDoneJYJ/urgeCheckDoneExl?checkApplyId="+checkApplyId+"&"+urgeCheck;
	});
...
function page(n, s) {
	...
	if (s)
		$("#pageSize").val(s);
	$("#urgeCheckDoneForm").attr("action",  ctx + "/urgeCheckDoneJYJ/urgeCheckDoneInfo");
	$("#urgeCheckDoneForm").submit();
	return false;
}