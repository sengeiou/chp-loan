...
$(document).ready(function() {
	...
	$("#shangF").click(function() {
		...
		$("#uploadAuditForm").attr("action", ctx + "/channel/Jyj/JyjgrantDeducts/fyImportResult?returnUrl=" + returnUrl + "&result=" + result);
	});
	...
	$("#shangH").click(function() {
		var result = $("#result").val();
		var returnUrl = $("#returnUrl").val();
		$("#uploadAuditForm").attr("action", ctx + "/channel/Jyj/JyjgrantDeducts/hylImportResult?returnUrl=" + returnUrl + "&result=" + result);
	});
	...
	$("#shangT").click(function() {
		var result = $("#result").val();
		var returnUrl = $("#returnUrl").val();
		$("#uploadAuditForm").attr("action", ctx + "/channel/Jyj/JyjgrantDeducts/tlImportResult?returnUrl=" + returnUrl + "&result=" + result);
	});
	...
	$("#shangZ").click(function() {
		var result = $("#result").val();
		var returnUrl = $("#returnUrl").val();
		$("#uploadAuditForm").attr("action", ctx + "/channel/Jyj/JyjgrantDeducts/zjImportResult?returnUrl=" + returnUrl + "&result=" + result);
	});
...
function back(checkVal, backPlat) {
	...
	$.ajax({
		type: 'post',
		url: ctx + '/channel/Jyj/JyjgrantDeducts/deductsBackSure',
		data: urgeMoney,
		dataType: 'text',
		cache: false,
		async: false,
		success: function(result) {
			...
			window.location.href = ctx + "/channel/Jyj/JyjgrantDeducts/deductsInfo?result=" + result + "&returnUrl=" + returnUrl;
		},
		error: function() {
...
function sendTo(cid, type, result, rule) {
	...
	$.ajax({
		type: 'post',
		url: ctx + '/channel/Jyj/JyjgrantDeducts/sendDeduct',
		data: urgeMoney,
		dataType: 'text',
		cache: false,
		async: false,
...
function excelDao(url) {
	...
	window.location.href = ctx + "/channel/Jyj/JyjgrantDeducts/" + url + "?cid=" + cid + "&resultString=" + result + "&returnUrl=" +returnUrl+ "&" + urgeMoney;
}
...
function updateAutoFlag(cid,autoFlag){
	...
	$.ajax({
		type: 'post',
		url: ctx + '/channel/Jyj/JyjgrantDeducts/updateAutoFlag',
		data: urgeMoney,
		dataType: 'text',
		cache: false,
		async: false,
		success: function(result) {
			...
			window.location.href = ctx + "/channel/Jyj/JyjgrantDeducts/deductsInfo";
		},
		error: function() {
			art.dialog.alert('请求异常！');
		}
