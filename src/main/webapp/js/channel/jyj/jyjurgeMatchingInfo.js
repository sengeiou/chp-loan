$(document).ready(function(){
	...
	$("[name='matchingPayback']").each(function(){
		$(this).bind('click',function(){
			...
			$.ajax({  
				   type : "POST",
				   async:false,
				   url : ctx+"/channel/jyj/urgeCheckMatch/getMatchingList",
				   data:data,
				   datatype : "json",
	...
	$("[name='downPng']").each(function(){
		$(this).bind('click',function(){
			window.location.href=ctx+"/channel/jyj/urgeCheckMatch/downPng?docId="+$(this).attr('docId')+"&fileName="+$(this).attr('fileName');
		});
	});
	...
	$('#matchingSemiautomatic').click(function(){	
		...
		$.ajax({  
			   ...
			   data:{
				...
				url : ctx+"/channel/jyj/urgeCheckMatch/matchingSingle",
