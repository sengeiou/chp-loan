...
$(document).ready(function() {
	...
	$("#shangF").click(function() {
		...
		$("#uploadAuditForm").attr("action", ctx + "/channel/Jyj/JyjgrantDeductsAlready/fyImportResult?returnUrl=" + returnUrl + "&result=" + result);
	});
	...
	$("#shangH").click(function() {
		var result = $("#result").val();
		var returnUrl = $("#returnUrl").val();
		$("#uploadAuditForm").attr("action", ctx + "/channel/Jyj/JyjgrantDeductsAlready/hylImportResult?returnUrl=" + returnUrl + "&result=" + result);
	});
	...
	$("#shangT").click(function() {
		var result = $("#result").val();
		var returnUrl = $("#returnUrl").val();
		$("#uploadAuditForm").attr("action", ctx + "/channel/Jyj/JyjgrantDeductsAlready/tlImportResult?returnUrl=" + returnUrl + "&result=" + result);
	});
	...
	$("#shangZ").click(function() {
		var result = $("#result").val();
		var returnUrl = $("#returnUrl").val();
		$("#uploadAuditForm").attr("action", ctx + "/channel/Jyj/JyjgrantDeductsAlready/zjImportResult?returnUrl=" + returnUrl + "&result=" + result);
	});
...
function back(checkVal, backPlat) {
	...
	$.ajax({
		type: 'post',
		url: ctx + '/channel/Jyj/JyjgrantDeductsAlready/deductsBackSure',
		data: urgeMoney,
		dataType: 'text',
		cache: false,
		async: false,
		success: function(result) {
			...
			window.location.href = ctx + "/channel/Jyj/JyjgrantDeductsAlready/deductsInfo?result=" + result + "&returnUrl=" + returnUrl;
		},
		error: function() {
...
function sendTo(cid, type, result, rule) {
	...
	$.ajax({
		type: 'post',
		url: ctx + '/channel/Jyj/JyjgrantDeductsAlready/sendDeduct',
		data: urgeMoney,
		dataType: 'text',
		cache: false,
		async: false,
...
function excelDao(url) {
	...
	window.location.href = ctx + "/channel/Jyj/JyjgrantDeductsAlready/" + url + "?cid=" + cid + "&resultString=" + result + "&returnUrl=" +returnUrl+ "&" + urgeMoney;
}
...
function updateAutoFlag(cid,autoFlag){
	...
	$.ajax({
		type: 'post',
		url: ctx + '/channel/Jyj/JyjgrantDeductsAlready/updateAutoFlag',
		data: urgeMoney,
		dataType: 'text',
		cache: false,
		async: false,
		success: function(result) {
			...
			window.location.href = ctx + "/channel/Jyj/JyjgrantDeductsAlready/deductsInfo";
		},
		error: function() {
			art.dialog.alert('请求异常！');
		}
