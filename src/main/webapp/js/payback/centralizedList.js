...
function page(n, s) {
	...
	$("#auditForm").attr("action",
			ctx + "/borrow/centralized/deduct/allCentralizedDeductionList?menuId="+menuId);
	$("#auditForm").submit();
	return false;
}
		...
		.ready(
				function() {
									...
									function() {
										...
										$("#auditForm")
												.attr(
														"action",
														ctx
																+ "/borrow/centralized/deduct/exportExcel");
										$("#auditForm").submit();
									});
					...
					$("#clearBtn").click(
						function() {
							var menuId = $("#menuId").val();
							window.location.href =ctx+ "/borrow/centralized/deduct/allCentralizedDeductionList?menuId"+menuId;
						}
					);
					// 搜索按钮
					$("#searchBtn").click(
						function() {
							$("#auditForm")
									.attr("action",ctx+ "/borrow/centralized/deduct/allCentralizedDeductionList");
							$("#auditForm").submit();
