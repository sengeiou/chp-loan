$(document).ready(function(){
	...
	$('#derivedAuditedBtn').click(function(){
		...
		window.location.href=ctx+"/borrow/payback/audited/derivedAuditedExl?audited=" + audited + "&"+auditeDate;
	})
	...
	$('#uploadAuditedFile').click(function() {
		...
		$("#uploadAuditForm").ajaxSubmit({
			type: "POST",
			url:ctx + "/borrow/payback/audited/importAuditedExl",
			dataType: "json",
		     			...
		     			$("#uploadAuditForm").ajaxSubmit({
		     			    ...
		     			    success: function(data){
		     			    	window.setTimeout(function () { 
		     			    		...
		     			    		window.location.href=ctx+"/borrow/payback/audited/list?menuId="+menuId;
		     			    		}, 2000);
		     				}
		     			});
		     		});
...
function page(n, s) {
	...
	if (s)
		$("#pageSize").val(s);
	$("#auditForm").attr("action",  ctx + "/borrow/payback/audited/list");
	$("#auditForm").submit();
	return false;
}