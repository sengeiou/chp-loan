...
// 下一步的校验
jQuery.validator.addMethod("isNext", function(value, element) {
	var isOK = true;
	var cardType = $("#dictOperStatus option:selected").val();
	if(cardType == ""){
			isOK = false;
	}
    var length = value.length;
	...
	$("#consultForm").validate(
			{
				...
				rules : {
            	   ...
            	   'appCustomerInfo.telephoneNo':{
            		   maxlength:8,
            		   minlength:7,
            		   digits:true
                   },
            	   'appCustomerInfo.loanStatus':{
            		   isNext:true
            	   }
				},
				messages : {
