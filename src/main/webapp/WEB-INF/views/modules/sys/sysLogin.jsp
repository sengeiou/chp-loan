...
<body>
	...
	<form id="loginForm" class="form-signin" action="${ctx}/login" method="post" >
		<label class="input-label" for="username" style="font-size:13px">用户名：</label>
		       <input type="text" id="username" name="username" class="input-block-level required" value="${username}"> 		
		<label class="input-label" for="password" style="font-size:13px">密<span style="padding-right:14px"></span>码：</label>
		...
		<p class='login-in'>
		     <input class="btn btn-large btn-primary" type="submit" value="登 录"/></p>
	...
	<br/><br/><br/>
	<div class="footer"> 
		Copyright &copy; 2015　<a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> 
	</div>
