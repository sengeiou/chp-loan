...
<body>
<div class="body_r">
     <p class="bar"><span class="color_b97226">首页>交互管理></span>邮件模板新增管理</p>
    <div class="box1 mb10">
       <form action="${ctx }/borrow/template/email/saveEmailTemplate" method="post">
        <table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
             ...
             <tr>
                ...
                <td><label class="lab"><span class='red'>*</span>模板类型：</label><select class="input_text178" name="templateType" value="${templateType }"><option>请选择</option></select></td>
            </tr>
        </table>
