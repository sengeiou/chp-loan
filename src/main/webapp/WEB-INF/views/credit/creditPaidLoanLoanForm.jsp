...
<%@ include file="/WEB-INF/views/include/taglib.jsp"%>
	<div id="paidLoanLoanTab" >
		<form id="paidLoanLoanForm">
		<table id="paidLoanLoanTable" cellpadding="0" cellspacing="0" border="0"  width="100%" class="table2">
			<thead>
				<tr>					
					<th>授信机构</th>
					<th>币种</th>
			...
			<c:forEach var="paidLoan" items="${paidLoanList}" varStatus="sta">
				<c:if test="${paidLoan.businessType eq 1}">
				<tr id="infoTr${sta.index + 1}">
					...
					<td>
						...
						<input  name="businessAmountName" class="input_text70 " type="text" money="1" maxlength="12" 
							...
							onblur="formatMoney('paidLoanLoan', '${sta.index}', 'businessAmount');" />
					</td>					
					...
					<td><a name="aRemoveInfo" onClick="removeTr('paidLoanLoan', '${sta.index + 1}');" href="javascript:void(0);" >删除</a></td>
		...
		<table id="paidLoanLoanTableHide" class="hide">
			<tbody>
				<tr id="infoTr">
