...
<%@ include file="/WEB-INF/views/include/taglib.jsp"%>
	<div id="unclearLoanNotesTab" >
		<form id="unclearLoanNotesForm">
		
		<table id="unclearLoanNotesTable" cellpadding="0" cellspacing="0" border="0"  width="100%" class="table2">
			<thead>
				<tr>					
					<th>授信机构</th>
					<th>币种</th>
			...
			<c:forEach var="unclearLoan" items="${unclearedImproperLoanList}" varStatus="sta">
				<c:if test="${unclearLoan.businessType eq 4}">
				<tr id="infoTr${sta.index + 1}">
					...
					<td>
						...
						<input  name="businessAmountName" class="input_text70 " type="text" money="1" maxlength="12" 
							...
							onblur="formatMoney('unclearLoanNotes', '${sta.index}', 'businessAmount');" />
					</td>	
				<%-- 	<td>
						...
						<input  name="businessBalanceName" class="input_text70 " type="text" money="1" maxlength="12" 
							...
							onblur="formatMoney('unclearLoanNotes', '${sta.index}', 'businessBalance');" />
					</td>	 --%>			
					...
					<td><a name="aRemoveInfo" onClick="removeTr('unclearLoanNotes', '${sta.index + 1}');" href="javascript:void(0);" >删除</a></td>
		...
		<table id="unclearLoanNotesTableHide" class="hide">
			<tbody>
				<tr id="infoTr">
					...
					<td>
						...
						<input  name="businessAmountName" class="input_text70 " type="text" money="1" maxlength="12"/>
						<input  type="hidden" name="businessBalance" value="0" class="input_text70 number " money="1" maxlength="12" />
					</td>	
					<!-- <td>
