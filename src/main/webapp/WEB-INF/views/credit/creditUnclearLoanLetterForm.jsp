...
<%@ include file="/WEB-INF/views/include/taglib.jsp"%>
	<div id="unclearLoanLetterTab" >
		<form id="unclearLoanLetterForm">
		
		<table id="unclearLoanLetterTable" cellpadding="0" cellspacing="0" border="0"  width="100%" class="table2">
			<thead>
				<tr>					
					<th>授信机构</th>
					<th>币种</th>
			...
			<c:forEach var="unclearLoan" items="${unclearedImproperLoanList}" varStatus="sta">
				<c:if test="${unclearLoan.businessType eq 7}">
				<tr id="infoTr${sta.index + 1}">
					...
					<td>
						...
						<input  name="businessAmountName" class="input_text70 " type="text" money="1" maxlength="12" 
							...
							onblur="formatMoney('unclearLoanLetter', '${sta.index}', 'businessAmount');" />
					</td>
					<td>
					...
					<td>
						...
						<input  name="businessBalanceName" class="input_text70 " type="text" money="1" maxlength="12" 
							...
							onblur="formatMoney('unclearLoanLetter', '${sta.index}', 'businessBalance');" />
					</td>				
					...
					<td><a name="aRemoveInfo" onClick="removeTr('unclearLoanLetter', '${sta.index + 1}');" href="javascript:void(0);" >删除</a></td>
		...
		<table id="unclearLoanLetterTableHide" class="hide">
			<tbody>
				<tr id="infoTr">
