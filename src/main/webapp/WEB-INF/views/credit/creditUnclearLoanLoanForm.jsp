...
<%@ include file="/WEB-INF/views/include/taglib.jsp"%>
	<div id="unclearLoanLoanTab" >
		<form id="unclearLoanLoanForm">
		
		<table id="unclearLoanLoanTable" cellpadding="0" cellspacing="0" border="0"  width="100%" class="table2">
			<thead>
				<tr>					
					<th>授信机构</th>
					<th>币种</th>
			...
			<c:forEach var="unclearLoan" items="${unclearedImproperLoanList}" varStatus="sta">
				<c:if test="${unclearLoan.businessType eq 1}">
				<tr id="infoTr${sta.index + 1}">
					...
					<td>
						<input  type="hidden" name="businessAmount" value="${unclearLoan.businessAmount}"
							 class="input_text70 number " money="1" maxlength="12" />
						<input  name="businessAmountName" class="input_text70  " type="text" money="1" maxlength="12"
							 ...
							 onblur="formatMoney('unclearLoanLoan', '${sta.index}', 'businessAmount');" />
					</td>	
					<td>
						...
						<input  name="businessBalanceName" class="input_text70 " type="text" money="1" maxlength="12" 
							...
							onblur="formatMoney('unclearLoanLoan', '${sta.index}', 'businessBalance');" />					
					</td>				
					...
					<td><a name="aRemoveInfo" onClick="removeTr('unclearLoanLoan', '${sta.index + 1}');" href="javascript:void(0);" >删除</a></td>
		...
		<table id="unclearLoanLoanTableHide" class="hide">
			<tbody>
				<tr id="infoTr">
					...
					<td><select name="dictCurrency" class="select78 ">
							<option value="" >请选择</option>
							<c:forEach items="${fns:getDictList('jk_enterprise_currency')}" var="item">
					...
					<td>
						<input  type="hidden" name="businessBalance" class="input_text70 number " money="1" maxlength="12" />
						<input  name="businessBalanceName" class="input_text70 " type="text" money="1" maxlength="12"/>
					</td>				
