...
function page(n,s) {
	if (n) $("#pageNo").val(n);
	if (s) $("#pageSize").val(s);
	$("#singleForm").attr("action", "${ctx}/borrow/delivery/deliveryWaitOneList");
	$("#singleForm").submit();
}
...
// var deliveryData=${delPageOne.list[0].loanStoreOrgId}+','+${delPageOne.list[0].teamManagerCode}+',';
/*  +','+${delPageOne.list[0].teamManagerCode}+','
+${delPageOne.list[0].loanTeamOrgId}+','+${delPageOne.list[0].managerCode}+','
+${delPageOne.list[0].customerServicesCode}+','+${paramsOne.typeRoleOne }+','+${paramsOne.loanCode }+','
+${paramsOne.deliveryResultP }+','+${paramsOne.custCodeP }+','+${paramsOne.custNameP }+','+${paramsOne.typeRoleP }; */

</script>
</head>
<body>
	<div class="control-group">
		<form id="singleForm" method="post" action="${ctx}/borrow/delivery/deliveryWaitOneList">
			...
			<input id="loanCode" name="loanCode" type="hidden" value="${paramsOne.loanCode}" />
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<thead>
			<tr>
				...
				onclick="blBtnOne('${delPageOne.list[0].loanStoreOrgId}','${delPageOne.list[0].teamManagerCode}',
				'${delPageOne.list[0].loanTeamOrgId}','${delPageOne.list[0].managerCode}',
				'${delPageOne.list[0].customerServicesCode}','${paramsOne.typeRoleOne }','${paramsOne.loanCode }',
