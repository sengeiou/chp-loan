...
<script src="${context}/js/grant/GCGrantDone.js" type="text/javascript"></script>
<script>
function page(n, s) {
	if (n)
		$("#pageNo").val(n);
	if (s)
		$("#pageSize").val(s);
	$("#grantForm").attr("action", "${ctx}/channel/goldcredit/grantDone/grantDone");
	$("#grantForm").submit();
	return false;
}
$(function (){
...
<body>	
	...
	<form:form id="grantForm"  modelAttribute="loanGrantEx" method="post" action="${ctx}/channel/goldcredit/grantDone/grantDone">
