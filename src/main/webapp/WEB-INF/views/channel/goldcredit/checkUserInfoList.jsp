...
<div class="body_r">
    ...
    <div class="box2 ">
        <table class=" table1" cellpadding="0" cellspacing="0" border="0" width="100%">
       	 <c:if test="${ house!=null && fn:length(house)>0}">
        	 <c:forEach items="${house}" var="item" varStatus="status">
	            <tr>
	                <td width="32%"><label class="lab">房产具体信息：</label><input type="text" class="input_text178" value="${item.house_base_info }"></td>
	            	<td width="32%"><label class="lab">房产地址：</label><input type="text" class="input_text178" value="${item.house_address }"></td>
	                <td width="32%"><label class="lab">购买方式：</label><select class="select180">
						 <option value="">请选择</option>
							 <c:forEach items="${fns:getDictList('jk_house_buywayg')}"
									var="house_buywayg">
									<option value="${house_buywayg.value}" <c:if test="${house_buywayg.value == item.house_buyway }">selected=true</c:if>>${house_buywayg.label}</option>
							</c:forEach>
						</select>
	                </td>
	            </tr>
	            <tr>
	                <td width="32%"><label class="lab">建筑年份：</label><input type="text" class="input_text178" value="${item.house_create_day }"></td>
	                <td width="32%"><label class="lab">房屋面积：</label><input type="text" class="input_text178" value="<fmt:formatNumber value='${item.house_builing_area }' pattern="#,##0.00"/>"></td>
	                <td width="32%"><label class="lab">购买日期：</label><input type="text" class="input_text178" value="${item.house_buyday }"></td>
	            <tr>
	            <td width="32%"><label class="lab">月还款（元）：</label><input type="text" class="input_text178" value="<fmt:formatNumber value='${item.house_month_repay_amount }' pattern="#,##0.00" />"></td>
         ...
         <c:if test="${ house==null || fn:length(house)==0}">
          		<tr>
	                <td width="32%"><label class="lab">房产具体信息：</label><input type="text" class="input_text178" ></td>
	            	<td width="32%"><label class="lab">房产地址：</label><input type="text" class="input_text178" ></td>
	                <td width="32%"><label class="lab">购买方式：</label><select class="select180">
						 <option value="">请选择</option>
	            ...
	            <tr>
	                <td width="32%"><label class="lab">建筑年份：</label><input type="text" class="input_text178" ></td>
	                <td width="32%"><label class="lab">房屋面积：</label><input type="text" class="input_text178" ></td>
	                <td width="32%"><label class="lab">购买日期：</label><input type="text" class="input_text178" ></td>
	            <tr>
	            <td width="32%"><label class="lab">月还款（元）：</label><input type="text" class="input_text178" ></td>
	               <%-- <td width="32%"><label class="lab">按揭银行：</label><input type="text" class="input_text178" value="${info.dict_house_bank }"></td> --%>
	                <%-- <td width="32%"><label class="lab">贷款总额（元）：</label><input type="text" class="input_text178" value="<fmt:formatNumber value='${info.house_loan_amount }' pattern="#,#00.00" />"></td> --%>
	                <%-- <td width="32%"><label class="lab">购买价格（元）：</label><input type="text" class="input_text178" value="<fmt:formatNumber value='${info.house_amount }' pattern="#,#00.00" />"></td> --%>
	            </tr>
   ...
   <h4 class="f14 pl10 mt20">联系人资料(2名亲属、2名朋友、2名同事，最少1名联系人为直系亲属)</h4>
    ...
    <div class="box2 mt20">
        <table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
            ...
            <tr>
           		<td><label class="lab">备注：</label><textarea class="textarea_refuse" disabled="disabled">${info.remark }</textarea></td>
            </tr>
        </table>
    </div>
    <div class="tright mt10 mb30 pr30"><button class="btn btn-primary" onclick="history.go(-1);">返回</button></div>
</div>
