...
<html>
<head>
<script type="text/javascript" src="${context }/js/channel/jyj/jyjurgeMatchingPayback.js"></script>
...
<body>
	<div class="control-group">
		<form id="urgeMatchingForm" action="${ctx}/channel/jyj/urgeCheckMatch/urgeCheckMatchInfo" method ="post" >
	...
	<div id="matchingList" class="box5">
		<form id="matchingInfoForm" action="${ctx}/channel/jyj/urgeCheckMatch/form" method="post">
		...
		<table id="urgeMatchingTab">
			<thead>
				<tr height="37px">
		            ...
		            <th data-field="firstGrantAmount" >首次放款金额</th>
		            <th data-field="allFee" >费用总金额</th>
		            <th data-field="feeCount">前期综合服务费</th>
		            <th data-field="feePetition">外访费</th>
		            <th data-field="feeExpedited">加急费</th>
		            <th data-field="waitUrgeMoeny" >待查账金额</th>
				...
				<tbody id="applyPayMatchingListBody">
					<c:forEach items="${paybackApplyList.list}" var="item">
						<tr>
							...
							<td><fmt:formatNumber value='${item.firstGrantAmount}' pattern="#,##0.00"/></td>
							<td><fmt:formatNumber value='${item.allFee}' pattern="#,##0.00"/></td>
							<td><fmt:formatNumber value='${item.feeCount}' pattern="#,##0.00"/></td>
