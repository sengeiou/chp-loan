...
<script type="text/javascript" src="${context }/js/channel/jyj/jyjurgeMatchingInfo.js"></script>
...
<body>
	...
	<form id="paybackInfoForm" action="${ctx}/channel/jyj/urgeCheckMatch/save" method="post" class="form-horizontal">
		...
		<input type="hidden" name="payback.paybackBuleAmount" value="${paybackApply.payback.paybackBuleAmount}"/>
			...
			<table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
				...
				<tr>
					<td><label class="lab">门店名称：</label> <input type="text"
						...
						readonly></td>
					<td><label class="lab">待查账金额：</label> <input type="text"
		...
		<div class="box2 mb10" id="qishu_div1">
			<table class="table1" cellpadding="0" cellspacing="0" border="0"
				...
				<tr>
					...
					<td><label class="lab">查账申请日期：</label> <input type="text"
