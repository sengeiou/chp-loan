...
<html>
<head>
<title>简易借待划扣失败列表</title>
<script type="text/javascript" language="javascript"
	src='${context}/js/common.js'></script>
<script src="${context}/js/channel/jyj/jyjGrantDeductsAlready.js?version=20161209" type="text/javascript"></script>
<script>
function page(n, s) {
	if (n)
		$("#pageNo").val(n);
	if (s)
		$("#pageSize").val(s);
	$("#deductsForm").attr("action", "${ctx}/channel/Jyj/JyjgrantDeducts/deductsInfo");
	$("#deductsForm").submit();
	return false;
}
//省市级联
	...
	<div class="control-group">
       ...
       <form:form  method="post" modelAttribute="urgeMoneyEx" id="deductsForm">
        ...
        <tbody>
         ...
         <c:if test="${ urgeList==null || fn:length(urgeList.list)==0}">
           <tr><td colspan="22" style="text-align:center;">没有待办数据</td></tr>
         </c:if>
     </tbody>
    </table>
