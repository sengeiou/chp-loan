...
<script type="text/javascript">
	...
	function page(n,s) {
		if (n) $("#pageNo").val(n);
		if (s) $("#pageSize").val(s);
		$("#accountHandleForm").attr("action", "${ctx}/borrow/account/repayaccount/accountHandleList");
...
<body>
	<div class="control-group">
		<form id="accountHandleForm" action="${ctx}/borrow/account/repayaccount/accountHandleList" method="post">
