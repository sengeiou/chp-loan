		...
		<tbody>
			<tr>
				...
				<td>
					...
					<input type="text" class="input-medium" value="${repayAccountApplyView.updatecontent}"  readonly="readonly"/>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					...
					<input type="text" class="input-medium" value="${repayAccountApplyView.customerEmail}" readonly="readonly"/>
				</td>
			</tr>
			<tr>
				<td>
