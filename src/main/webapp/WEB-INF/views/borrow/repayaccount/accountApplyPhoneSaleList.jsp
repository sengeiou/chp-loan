...
<body>
	<div class="control-group">
		<form id="accountApplyForm" action="${ctx}/borrow/account/repayaccount/accountApplyPhoneSaleList" method="post">
	...
	<div id="editAccountDiv" class=" pb5 pt10 pr30 title ohide" style="display:none">
		<form id="editAccountMessage" class="validate" action="${ctx}/borrow/account/repayaccount/savePhoneSaleAccountMessage" method="post" enctype="multipart/form-data">
	...
	<div id="editPhoneDiv" class=" pb5 pt10 pr30 title ohide" style="display:none">
		<form id="editPhoneMessage" class="validate" action="${ctx}/borrow/account/repayaccount/savePhoneSaleAccountMessage" method="post" enctype="multipart/form-data">
	...
	<div id="editEmail" class=" pb5 pt10 pr30 title ohide" style="display:none">
		<form id="editEmailMessage" class="validate" action="${ctx}/borrow/account/repayaccount/savePhoneSaleAccountMessage" method="post" enctype="multipart/form-data">
			<input name="repayAccountTokenId" type="hidden" value="${repayAccountApplyView.repayAccountTokenId}" />
			<input name="repayAccountToken" type="hidden" value="${repayAccountApplyView.repayAccountToken}" />
	...
	<div id="addDiv" class=" pb5 pt10 pr30 title ohide" style="display:none">
		<form id="addAccountMessage" class="validate" action="${ctx}/borrow/account/repayaccount/savePhoneSaleAccountMessage" method="post" enctype="multipart/form-data">
