...
<script type="text/javascript" src="${context}/js/serve/sendList.js"></script>
<script type="text/javascript" src="${context}/js/common.js"></script>
</head>
<body>
	<div class = "control-group">
		<form id="waitSendForm" action="${ctx }/borrow/serve/emailServe/sendList" method="post">
			<input id="pageNo" name="pageNo" type="hidden"	value="${page.pageNo}" /> 
			<input id="pageSize" name="pageSize" type="hidden" />
			<input id="ids" type="hidden" name="ids"/>
			<input id="exportType" type="hidden" name="exportType" value="2"/>
			...
			<table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
				...
				<tr>
					...
					<td>
						<label class="lab">发送时间：</label>
						<input
								name="modifyTime" type="text" readonly="readonly" maxlength="40"
								class="input-mini Wdate"
								value="<fmt:formatDate value="${sendEmail.modifyTime}" pattern="yyyy-MM-dd"/>"
