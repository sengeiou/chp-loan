...
<title>放款确认</title>
<script src="${context}/js/grant/urgeGuarante.js" type="text/javascript"></script>
<style type="text/css">
#file {
	border-radius: 8px;
	width:70%;
...
<body>
	...
	<form id="applyPayLaunchForm" enctype="multipart/form-data" action="${ctx}/borrow/grant/urgeGuaranteeMoney/save" method="post">
	<div class="box2">
		<table class="table1" cellpadding="0" cellspacing="0" border="0"
			...
			<tr>
				<td><label class="lab">催收金额：</label>${UrgeServicesMoneyEx.urgeMoeny}</td>
				<td><label class="lab">待催收金额：</label>${UrgeServicesMoneyEx.waitUrgeMoeny}</td>
			...
			<tr>
				...
				<fmt:formatNumber value='${UrgeServicesMoneyEx.urgeMoeny}' pattern="#,#00.00" /></td>
				...
				<fmt:formatNumber value='${UrgeServicesMoneyEx.grantAmount}' pattern="#,#00.00" /></td>
