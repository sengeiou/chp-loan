...
<script type="text/javascript" src="${context}/js/grant/urgeCheckDone.js"></script>
...
<!-- 催收服务费查账已办列表 -->
	<div class="control-group">
		<form:form id="urgeCheckDoneForm" action="${ctx}/borrow/grant/urgeCheckDone/urgeCheckDoneInfo" method ="post" modelAttribute="urgeCheckDoneEx">
	...
	<div id="matchingList">
		<form id="matchingInfoForm" action="${ctx}/borrow/grant/urgeCheckDone/form" method="post">
				...
				<tbody id="applyPayMatchingListBody">
					<c:forEach items="${waitPage.list}" var="item">
						<tr>
							...
							<td><c:if test="${item.productName=='农信借'}">
									<fmt:formatNumber value='${item.feePetition}' pattern="#,##0.00" />
								</c:if>
							</td>
