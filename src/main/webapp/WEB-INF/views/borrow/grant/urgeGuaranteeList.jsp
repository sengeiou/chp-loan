...
<script language="javascript"> 
	function page(n, s) {
		...
		if (s)
			$("#pageSize").val(s);
		$("#backForm").attr("action", "${ctx}/borrow/grant/urgeGuaranteeMoney/urgeGuarantInfo");
		$("#backForm").submit();
		return false;
	}
</script>
...
<body>
   ...
   <form:form action="${ctx }/borrow/grant/urgeGuaranteeMoney/urgeGuarantInfo" method="post" id="backForm" modelAttribute="UrgeServicesMoneyEx">
