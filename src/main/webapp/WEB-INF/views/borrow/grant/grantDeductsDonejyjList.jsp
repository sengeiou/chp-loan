...
<script src="${context}/js/grant/grantDeductsJYJ.js" type="text/javascript"></script>
<script>
function page(n, s) {
	if (n)
		$("#pageNo").val(n);
	if (s)
		$("#pageSize").val(s);
	$("#deductsForm").attr("action", "${ctx }/grantDeductsDoneJYJ/deductsDoneInfo");
	$("#deductsForm").submit();
	return false;
}
//省市级联
        ...
        <tbody>
         ...
         <c:set var="index" value="0"/>
          ...
          <c:set var="index" value="${index+1}" />
             ...
             <td><fmt:formatNumber value='${item.firstGrantAmount}' pattern="#,#00.00"/></td> <!-- 首次放款金额 -->
