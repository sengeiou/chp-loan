...
<body>
 <ul class="nav nav-tabs">
		...
		<li class="active"><a href="javascript:launch.getCustomerInfo('9');">银行卡信息</a></li>
	</ul>
...
<div id="div9" class="content control-group">
	  <form id="bankForm" method="post">
		...
		<input type="hidden" value="${workItem.bv.defToken}" name="defToken"/>
	  	...
	  	<input type="hidden" value="${workItem.bv.loanCustomer.customerName}"
				name="loanCustomer.customerName" id="loanCustomer_customerName"/>
        ...
        <table class=" table1" cellpadding="0" cellspacing="0" border="0" width="100%">
            ...
            <tr>
			 <td><label class="lab"><span class="red">*</span>开户行：</label>
						<select name="loanBank.bankName" id="bankName" class="select180 required">
