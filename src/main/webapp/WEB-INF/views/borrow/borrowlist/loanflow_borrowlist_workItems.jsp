...
<script type="text/javascript">
  ...
  function page(n, s) {
		...
		if (s)
			$("#pageSize").val(s);
		$("#inputForm").attr("action", "${ctx}/borrow/borrowlist/fetchTaskItems");
		$("#inputForm").submit();
		return false;
}
...
<body>
    ...
    <form:form id="inputForm" modelAttribute="loanFlowQueryParam" action="${ctx}/borrow/borrowlist/fetchTaskItems" method="post" class="form-horizontal">
