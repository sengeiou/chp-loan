...
<script type="text/javascript" src="${context }/js/payback/applyPaybackUsePhoneSale.js"></script>
...
<body>
	<div class="control-group">
		<form style="overflow-y: hidden;" id="applyPayBackUseForm" action="${ctx}/borrow/payback/applyPaybackUse/goPhoneSaleList" method="post">
	...
	<div class="modal fade" id="appplyPayBackUseModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form id="appplyPayBackUseForm" action="${ctx}/borrow/payback/applyPaybackUse/formPhoneSale" method="post">
