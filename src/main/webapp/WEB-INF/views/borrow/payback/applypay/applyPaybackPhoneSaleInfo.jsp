...
<script type="text/javascript" src="${context }/js/payback/applyPaybackPhoneSaleInfo.js"></script>
...
<body>
	...
	<form id="applyPayinfoForm" enctype="multipart/form-data" action="${ctx}/borrow/payback/applyPaybackUse/savePhoneSale" method="post" class="form-horizontal">
