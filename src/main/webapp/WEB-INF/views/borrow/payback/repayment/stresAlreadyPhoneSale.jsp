...
<title>门店已办页面</title>
<script type="text/javascript" src="${context}/js/payback/stresAlreadyPhoneSale.js"></script>
<script src='${context}/js/common.js' type="text/javascript"></script>
</head>
<body>
    <div class="control-group">
    <form id="auditForm"  method="post" action="${ctx}/borrow/payback/loanServices/phoneSalestoresAlreadyDoList">
