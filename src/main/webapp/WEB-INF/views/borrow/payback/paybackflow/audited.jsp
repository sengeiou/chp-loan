...
<script type="text/javascript" src="${context }/js/payback/audited.js?ver=23"></script>
...
<body>
	<div class="control-group">
		<form id="auditForm" action="${ctx}/borrow/payback/audited/list" >
			...
			<tbody id="prepareListBody">
				<c:forEach items="${paybackTransferOutList.list}" var="item">
					<tr>
						...
						<td>
						<c:if test="${jkhj_czzksjlb_transact==null }">
						<input type="button" class="btn_edit" id ="auditedMal" name="auditedMalBtn" auditedId="${item.id}" orderNumber="${item.orderNumber }"
	...
	<div class="modal fade" id="auditedModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<input name="menuId1"  id ="menuId1" type="hidden" value="${menuId}"/> 
					<table class="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
						<tr>
							<td><label class="lab" style="text-align: right">查账状态：</label>
	...
	<div class="modal fade" id="uploadAuditedModal" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form id="uploadAuditForm" role="form" enctype="multipart/form-data" action="${ctx}/borrow/payback/audited/importAuditedExl" method="POST">
