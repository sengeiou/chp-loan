...
<script type="text/javascript" src="${context }/js/payback/doStoreInfoPhoneSale.js"></script>
	...
	<form id="doStoreForm" enctype="multipart/form-data" action="${ctx}/borrow/payback/doStore/save" method="post" class="form-horizontal">
	   ...
	   <!-- POS刷卡 结束-->
		...
		<c:if test="${paybackApply.dictRepayMethod!='2'}"> 
			...
			<input class="btn btn-primary" type="button" onclick="JavaScript:window.location='${ctx}/borrow/payback/doStore/phoneSaleList'" value="返回">
		</div>
	</form>
