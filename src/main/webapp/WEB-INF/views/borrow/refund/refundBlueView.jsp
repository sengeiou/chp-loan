...
<body>
  ...
  <div class="box2">
        <table class=" table1" cellpadding="0" cellspacing="0" border="0" width="95%">
            ...
            <textarea rows="5" cols="6" maxlength="150" style="width:200px;height: 80px;vertical-align:top" class="required" name="paybackBuleReson" readonly>${refund.remark }</textarea>
                </td>
             </tr> 
            ...
            <textarea rows="5" cols="6" maxlength="150" style="width:200px;height: 80px;vertical-align:top" class="required" name="fkRemark" readonly>${refund.fkRemark }</textarea>
                </td>
                <td><label class="lab">审批意见：</label>
            <textarea rows="5" cols="6" maxlength="150" style="width:200px;height: 80px;vertical-align:top" class="required" name="zcemark" readonly>${refund.zcRemark }</textarea>
                </td>
             </tr> 
             <tr>
