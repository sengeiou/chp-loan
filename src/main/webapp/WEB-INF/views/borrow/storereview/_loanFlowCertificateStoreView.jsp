...
<script type="text/javascript">
 $(document).ready(function(){
	$('#certificateNextBtn').bind('click', function() {
		...
		launch.updateApplyInfo('8', 'certificateForm','certificateNextBtn');
	});
	...
	if(isBorrow != 1){
		...
		areaselect.initCity("masterAddressProvince", "masterAddressCity",
			 "masterAddressArea", $("#masterAddressCityHidden").val(),$("#masterAddressAreaHidden").val());
	}
...
<body>
	<ul class="nav nav-tabs">
		<li>
			<a href="javascript:launch.getCustomerInfo_storeView('1');">个人基本信息</a>
		</li>
		<li>
			<a href="javascript:launch.getCustomerInfo_storeView('2');">借款意愿</a>
		</li>
		<li>
			<a href="javascript:launch.getCustomerInfo_storeView('3');">工作信息</a>
		</li>
		<li>
			<a href="javascript:launch.getCustomerInfo_storeView('4');">联系人信息</a>
		</li>
		<li>
			<a href="javascript:launch.getCustomerInfo_storeView('5');">自然人保证人信息</a>
		</li>
		<li>
			<a href="javascript:launch.getCustomerInfo_storeView('6');">房产信息</a>
		</li>
		<li>
			<a href="javascript:launch.getCustomerInfo_storeView('7');">经营信息</a>
		</li>
		<li class="active">
			<a href="javascript:launch.getCustomerInfo_storeView('8');">证件信息</a>
		</li>
		<li>
			<a href="javascript:launch.getCustomerInfo_storeView('9');">银行卡信息</a>
		</li>
	...
	<div id="div8" class="content control-group">
		<form id="certificateForm" method="post">
			...
			<input type="hidden" name="loanPersonalCertificate.dictMarry" value="${applyInfoEx.loanPersonalCertificate.dictMarry}" id="dictMarry" />
			<h2 class=" pl10 f14 ">
				<b>户口本信息</b>
			</h2>
			...
			<div class="tright mb5 mr10">
				<input type="submit" id="certificateNextBtn" class="btn btn-primary" value="保存" />
			</div>
		</form>
	</div>
</body>
