...
$(document).ready(function(){
	$('#companyNextBtn').bind('click',function(){
		...
		launch.updateApplyInfo('3','companyForm','companyNextBtn'); 
	});
...
<body>
	<ul class="nav nav-tabs">
		...
		<li  class="active"><a href="javascript:launch.getCustomerInfo_storeView('3');">工作信息</a></li>
	...
	<div id="div6" class="content control-group">
		<form id="companyForm" method="post">
			...
			<input type="hidden" name="lastLoanStatus" value="${workItem.bv.lastLoanStatus}"/>
 			...
 			<input type="hidden" name="customerLoanCompany.rid" value="${workItem.bv.loanCustomer.id}">
 			<input type="hidden" name="loanCustomer.id" value="${workItem.bv.loanCustomer.id}">
 			<input type="hidden" name="loanInfo.loanCode" value="${workItem.bv.loanCode}" />
			...
			<table class=" table1" cellpadding="0" cellspacing="0" border="0" width="100%">
				<tr>
					...
					<td>
						...
						-
						<input style="width: 50px" type="text" name="customerLoanCompany.compTelExtension" value="${applyInfoEx.customerLoanCompany.compTelExtension}" class="input_text178 positiveInteger" />
					</td>
					<td>
						<label class="lab">
				...
				<tr>
					<td>
						<label class="lab"><span class="red">*</span>月税后工资(元)：</label>
