...
<%@ include file="/WEB-INF/views/include/taglib.jsp"%>
	...
	<div  class="hide" >
			<table id="myConfirmCopy" cellpadding="0" cellspacing="0" border="0"  width="100%" class="table03" >
                ...
                <td>
                <select mark="dictContactRelation" name="dictContactRelation" class="select180">
                ...
                <td><input type="text" mark="contactUint" name="contactUint" class="input_text178"/></td>
                <td>
                   <input type="text" mark="dictContactNowAddress" name="dictContactNowAddress"  class="input_text150" style="width:250px">
                </td>
                <td><input type="text" mark="compTel" name="compTel" class="input_text178 isTel"/></td>
                <td><input type="text" mark="contactUnitTel" name="contactUnitTel" class="input_text178"/></td>
