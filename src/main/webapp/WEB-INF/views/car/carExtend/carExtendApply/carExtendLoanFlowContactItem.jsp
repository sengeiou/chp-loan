...
<%@ include file="/WEB-INF/views/include/taglib.jsp"%>
	...
	<div  class="hide" >
			<table id="myConfirmCopy" cellpadding="0" cellspacing="0" border="0"  width="100%" class="table03" >
				...
				<tr>
                <td>
                <input type="hidden" mark="newLoanCode" name="newLoanCode">
                ...
                <input type="hidden" mark="id" name="id">
                 ...
                 <input type="text" mark="contactName" name="contactName" class="input_text70 required stringCheck"/>
                </td>
                ...
                <td><input type="text" maxlength="20" mark="contactUint" name="contactUint" class="input_text178"/></td>
                <td>
                   <input type="text" maxlength="50" mark="dictContactNowAddress" name="dictContactNowAddress"  class="input_text150" style="width:250px">
                </td>
                <td><input type="text" mark="compTel" name="compTel" class="input_text178 isTel"/></td>
                <td><input type="text" mark="contactUnitTel" name="contactUnitTel" class="input_text178 required"/></td>
