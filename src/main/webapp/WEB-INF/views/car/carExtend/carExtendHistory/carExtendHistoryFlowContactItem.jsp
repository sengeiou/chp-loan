	...
	<div  class="hide" >
			<table id="myConfirmCopy" cellpadding="0" cellspacing="0" border="0"  width="100%" class="table03" >
                ...
                <input type="hidden" mark="id" name="id">
                 ...
                 <input type="text" mark="contactName" name="contactName" class="input_text70 realName required stringCheck"/>
                </td>
                ...
                <td><input type="text" mark="contactUnitTel" name="contactUnitTel" class="input_text178 isMobile required"/></td>
