...
<script type="text/javascript">
 ...
 function page(n, s) {
		...
		if (s)
			$("#pageSize").val(s);
		$("#inputForm").attr("action", "${ctx}/car/carExtendWorkItems/fetchTaskItems/extendReceived");
		$("#inputForm").submit();
		return false;
} 
</script>
...
<body>
 ...
 <form:form id="inputForm" modelAttribute="carExtendFlowQueryView" action="${ctx}/car/carExtendWorkItems/fetchTaskItems/extendReceived" method="post" class="form-horizontal">
     ...
     <table class="table1 " cellpadding="0" cellspacing="0" border="0"width="100%">
		 ...
		 <td><label class="lab">借款期限：</label>
				<form:select path="loanMonths" class="select180">
				                	<option value="">请选择</option>
 ...
 <sys:columnCtrl pageToken="carExtendReceivedList"></sys:columnCtrl>
