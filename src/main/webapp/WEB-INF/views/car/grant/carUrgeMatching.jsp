...
<html>
<head>
<script type="text/javascript" src="${context }/js/car/grant/carUrgeMatchingPayback.js"></script>
...
<body>
	<div class="control-group">
		<form id="urgeMatchingForm" action="${ctx}/car/grant/urgeCheckMatch/urgeCheckMatchInfo" method ="post" >
	...
	<div id="matchingList" class="box5">
		<form id="matchingInfoForm" action="${ctx}/car/grant/urgeCheckMatch/form" method="post">
				...
				<tbody id="applyPayMatchingListBody">
					<c:forEach items="${paybackApplyList.list}" var="item">
						<tr>
							...
							<td><fmt:formatDate value="${item.urgeServicesCheckApply.urgeApplyDate}" type="date" pattern="yyyy-MM-dd"/></td>
