...
//------------------------------------------------------------------------------
        ...
        var _createNotify = function(){
            ...
            var notifyMsg=$('<div class="lobibox-notify-msg">' + me.$options.msg+ '</div>');
            //<a href="#" onclick="openUrl(\''+me.$options.url+'\')"/>
            var $body = $('<div></div>').addClass('lobibox-notify-body')
                    .append(notifyMsg)
                    .appendTo(notify);
            if (me.$options.title){
            	var notifyTitle=$('<div class="lobibox-notify-title">' + me.$options.title + '<div>');
                $body.prepend(notifyTitle);
                _addOnClick(notifyTitle,me.$options.url);
            }
            _addCloseButton(notify);
            _addOnClick(notifyMsg);
        ...
        var _addOnClick = function($el){
        	$el.click(function(ev){
        		$.ajax({
            		type : "POST",
            		url : me.$options.urlPath+"/cmsPush/delete",
