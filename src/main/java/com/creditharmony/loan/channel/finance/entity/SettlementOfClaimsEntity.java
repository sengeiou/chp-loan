...
public class SettlementOfClaimsEntity extends DataEntity<SettlementOfClaimsEntity> {
	...
	/* 原始期限（月） */
	@ExcelField(title = "债权转入期限（月）", type = 0, align = 2, sort = 60)
	private Integer loanInMonths;
	/* 原始借款开始日期 */
	...
	public Integer getLoanInMonths() {
		return loanInMonths;
	}
	public void setLoanInMonths(Integer loanInMonths) {
	...
	public Date getLoanContractEndDay() {
		return loanContractEndDay;
	}
	public void setLoanContractEndDay(Date loanContractEndDay) {
		this.loanContractEndDay = loanContractEndDay;
	}
	/* 原始借款到期日期 */
	...
	/* 债权导出日期 */
	@ExcelField(title = "债权转出日期  ", type = 0, align = 2, sort = 100)
	private Date loanContractEndDay;
	/* 提前结清日期 */
	@ExcelField(title = "提前结清日期", type = 0, align = 2, sort = 60)
