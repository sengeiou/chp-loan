 ...
 */
@LoanBatisDao
public interface GCCeilingDao extends CrudDao<GCCeiling> {
	/**
	 *  查询金信上限列表数据信息
	 ...
	 * @return 金信上限列表时数据
	 */
	public List<GCCeiling> getCeilingList(PageBounds pageBounds,Map<String,Object> conditions);
	public List<GCCeiling> getCeilingList(Map<String,Object> conditions);
	/**
	 *  查询金信上限列表总金额
	 * @param conditions 检索参数
	 * @return 金信上限列表总金额
