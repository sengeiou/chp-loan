...
public class ExportPaybackAuditHelper {
    ...
    private static void paybackSheetExcelCell(SXSSFWorkbook wb,ResultSet resultSet, Sheet dataSheet,int MAXCOLUMN) throws NumberFormatException, SQLException{
        ...
        while (resultSet.next()) {
            ...
            dictPayStatus.setCellValue(DictUtils.getLabel(dictMap,"jk_repay_apply_status",resultSet.getString("dictPayStatus")));//还款申请状态
            ...
            dictRepayMethod.setCellValue(DictUtils.getLabel(dictMap,"jk_repay_way",resultSet.getString("dictRepayMethod")));// 还款方式
            ...
            if(StringUtils.isNotEmpty(resultSet.getString("applyMoneyPayback"))){
            ...
            if(StringUtils.isNotEmpty(resultSet.getString("reallyAmount"))){
            ...
            dictPayUse.setCellValue(DictUtils.getLabel(dictMap,"jk_repay_type",resultSet.getString("dictPayUse")));//还款类型
            ...
            dictLoanStatus.setCellValue(DictUtils.getLabel(dictMap,"jk_loan_status",resultSet.getString("dictLoanStatus")));
            ...
            dictPayResult.setCellValue(DictUtils.getLabel(dictMap,"jk_counteroffer_result",resultSet.getString("dictPayResult")));//回盘结果
            ...
            String cellValue = resultSet.getString("paybackBuleAmount");
            if(cellValue!=null && !cellValue.equals("")){
            	paybackBuleAmount.setCellValue(Double.valueOf(cellValue));//蓝补金额
            }
