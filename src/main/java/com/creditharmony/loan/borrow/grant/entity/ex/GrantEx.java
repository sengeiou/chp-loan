 ...
 */
public class GrantEx extends DataEntity<GrantEx> {
	...
	// 放款金额4
	@ExcelField(title = "转账金额", type = 0, align = 2, sort = 40)
	...
	// 是否加急
	@ExcelField(title = "是否加急", type = 0, align = 2, sort = 150,dictType="jk_urgent_flag")
	private String loanUrgentFlag;
	// 征信费
	@ExcelField(title = "征信费", type = 0, align = 2, sort = 160)
	private String feeCredit;
	// 信访费
	@ExcelField(title = "信访费", type = 0, align = 2, sort = 170)
	private String feePetition;
	// 费用总计:催收费+信访费+征信费
	@ExcelField(title = "费用总计", type = 0, align = 2, sort = 180)
	private String feeSum;
	// 放款批次
	@ExcelField(title = "放款批次", type = 0, align = 2, sort = 190)
