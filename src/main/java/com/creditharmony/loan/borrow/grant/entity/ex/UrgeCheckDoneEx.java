...
public class UrgeCheckDoneEx extends DataEntity<UrgeCheckDoneEx> {
	// 关联类型,催收服务费
	...
	// 征信费
	@ExcelField(title = "征信费", type = 0, align = 2, sort = 90)
	private BigDecimal feeCredit;
	// 信访费
	@ExcelField(title = "信访费", type = 0, align = 2, sort = 100)
	private BigDecimal feePetition;
	// 费用总计
	@ExcelField(title = "费用总计", type = 0, align = 2, sort = 110)
	private BigDecimal feeSum;
	// 催收金额
	@ExcelField(title = "催收服务费总金额", type = 0, align = 2, sort = 120)
	private BigDecimal urgeMoeny;
	// 待催收金额
	@ExcelField(title = "待催收金额", type = 0, align = 2, sort = 130)
	private BigDecimal waitUrgeMoeny;
	// 申请金额
	@ExcelField(title = "申请查账金额", type = 0, align = 2, sort = 140)
	private BigDecimal urgeApplyAmount;
	// 实际到账金额
	@ExcelField(title = "实还金额", type = 0, align = 2, sort = 150)
	...
	// 查账日期不知道是否为申请表中的申请日期
	@ExcelField(title = "查账日期", type = 0, align = 2, sort = 160)
	...
	// 回盘结果
	@ExcelField(title = "回盘结果", type = 0, align = 2, sort = 170,dictType="jk_urge_counteroffer_result")
	private String urgeApplyStatus;
	// 回盘结果(名称)
	private String urgeApplyStatusLabel;
	private String urgeBackReason;
	// 标识
	@ExcelField(title = "标识", type = 0, align = 2, sort = 180,dictType = "jk_channel_flag")
