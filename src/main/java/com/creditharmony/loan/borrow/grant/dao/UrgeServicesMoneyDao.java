 ...
 */
@LoanBatisDao
public interface UrgeServicesMoneyDao extends CrudDao<UrgeServicesMoneyEx>{
...
public PageList<UrgeServicesMoneyEx> selectDeductsJYJSuccess(
		PageBounds pageBounds, UrgeServicesMoneyEx urgeMoneyEx);
}