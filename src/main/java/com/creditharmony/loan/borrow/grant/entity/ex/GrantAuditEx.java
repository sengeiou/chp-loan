 ...
 */
public class GrantAuditEx extends DataEntity<GrantAuditEx> {
	...
	// 借款类型，需要从字典表中取值
	@ExcelField(title = "借款类型", type = 0, align = 2, sort = 30, groups = 1)
	...
	// 征信费
	@ExcelField(title = "征信费", type = 0, align = 2, sort = 140, groups = 1)
	private Double feeCredit;
	// 信访费
	@ExcelField(title = "信访费", type = 0, align = 2, sort = 150, groups = 1)
	private Double feePetition;
	// 费用总计
	@ExcelField(title = "费用总计", type = 0, align = 2, sort = 170, groups = 1)
