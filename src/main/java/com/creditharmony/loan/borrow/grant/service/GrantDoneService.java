...
/**
 * 查询放款已办
 * @Class Name GrantDoneService
 * @author 朱静越
 * @Create In 2015年12月9日
 */
@Service("grantDoneService")
public class GrantDoneService extends CoreManager<LoanGrantDao, LoanGrantEx>{
	 ...
	 * By 朱静越
	 * @param page 分页查询对象
	 * @param loanGrantEx 检索条件
	 * @return page对象
	 */
	@Transactional(readOnly = true, value = "loanTransactionManager")
	public Page<LoanGrantEx> findGrantDone(Page<LoanGrantEx> page,LoanGrantEx loanGrantEx){
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("loanGrant", loanGrantEx);
		PageBounds pageBounds = new PageBounds(page.getPageNo(),page.getPageSize());
		PageList<LoanGrantEx> pageList = (PageList<LoanGrantEx>)loanGrantDao.findGrantDone(pageBounds, map);
