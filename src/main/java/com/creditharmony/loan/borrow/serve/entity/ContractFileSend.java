 ...
 * @Create In 2016年2月1日
 */
public class ContractFileSend extends DataEntity<ContractFileSend> {
	...
	@ExcelField(title = "收件人地址", type = 1, align = 0, sort = 60, groups = 2)
...
//	@ExcelField(title = "分类(合同/结清证明)", type = 1, align = 0, sort = 70, groups = 2, dictType = "jk_cm_admin_file_type")
	...
	@ExcelField(title = "渠道", type = 1, align = 0, sort = 110, groups = {1,2})
	private String loanFlagName;
	private String mark;//渠道
	private String markName;//渠道名称
	private String model;		//	模式
	@ExcelField(title = "是否无纸化", type = 1, align = 0, sort = 120, groups = {1,2})
