...
/**
 * 设置借款表中orderField 用于页面的排序
 * @Class Name CreateOrderFileld
 * @author songfeng
 * @Create 2017年3月1日
 */
@Service
public class CreateOrderFileldService extends BaseService {
     ...
     * @return
     */
    public String sendDisCardByGrantSure(LoanInfo loaninfo){
    	Map<String,String> param = new HashMap<String,String>();
        param.put("applyId", loaninfo.getApplyId());
    	LoanInfo loanInfo = loanInfoDao.findLoanLinkedContract(param);
        Contract contractInfo = contractDao.findByApplyId(loaninfo.getApplyId());
        ...
        String code = loaninfo.getDictLoanStatus()+"-0"+urgentFlag+"-"+frozenFlag+"-"+backFlag;
     ...
     * @return
     */
    public String backCheckContractByGrantSure(LoanInfo loaninfo){
    	Map<String,String> param = new HashMap<String,String>();
        param.put("applyId", loaninfo.getApplyId());
    	LoanInfo loanInfo = loanInfoDao.findLoanLinkedContract(param);
        String urgentFlag = loanInfo.getLoanUrgentFlag();
    	...
    	String code = loaninfo.getDictLoanStatus()+"-0"+urgentFlag+"-"+frozenFlag+"-01";
        OrderFiled filed = OrderFiled.parseByCode(code);
        String orderField = filed.getOrderId(); 
        if(!ObjectHelper.isEmpty(loanInfo.getModifyTime())){
            orderField +="-"+DateUtils.formatDate(loanInfo.getModifyTime(), "yyyy.MM.dd HH:mm:ss");
     ...
     * @return
     */
    public String backCheckContractByDiscard(LoanInfo loaninfo){
    	Map<String,String> param = new HashMap<String,String>();
        param.put("applyId", loaninfo.getApplyId());
    	LoanInfo loanInfo = loanInfoDao.findLoanLinkedContract(param);
        String urgentFlag = loanInfo.getLoanUrgentFlag();
     ...
     * @return
     */
	public String backFrozenCodeByDiscard(LoanInfo loaninfo) {
		Map<String, String> param = new HashMap<String, String>();
		param.put("applyId", loaninfo.getApplyId());
		LoanInfo loanInfo = loanInfoDao.findLoanLinkedContract(param);
		String urgentFlag = loanInfo.getLoanUrgentFlag();
        ...
        String code = loaninfo.getDictLoanStatus()+"-0"+urgentFlag+"-"+frozenFlag+"-00";
        OrderFiled filed = OrderFiled.parseByCode(code);
        String orderField = filed.getOrderId(); 
        if(!ObjectHelper.isEmpty(loanInfo.getModifyTime())){
            orderField +="-"+DateUtils.formatDate(loanInfo.getModifyTime(), "yyyy.MM.dd HH:mm:ss");
     ...
     * @return
     */
	public void backContractCheckByGrant(LoanInfo loaninfo) {
		Map<String, String> param = new HashMap<String, String>();
		param.put("applyId", loaninfo.getApplyId());
		LoanInfo loanInfo = loanInfoDao.findLoanLinkedContract(param);
		String urgentFlag = loanInfo.getLoanUrgentFlag();
		...
		String backFlag = "01";
        String code = "";
        code =  loaninfo.getDictLoanStatus()+"-0"+urgentFlag+"-"+frozenFlag+"-"+backFlag;
        OrderFiled filed = OrderFiled.parseByCode(code);
        String orderField = filed.getOrderId(); 
        if(!ObjectHelper.isEmpty(loanInfo.getModifyTime())){
        orderField +="-"+DateUtils.formatDate(loanInfo.getModifyTime(), "yyyy.MM.dd HH:mm:ss");
        ...
        loanParam.put("loanCode", loanInfo.getLoanCode());
     ...
     * @return
     */
	public String backJxBackByGrant(LoanInfo loaninfo) {
		Map<String, String> param = new HashMap<String, String>();
		param.put("applyId", loaninfo.getApplyId());
		LoanInfo loanInfo = loanInfoDao.findLoanLinkedContract(param);
		String urgentFlag = loanInfo.getLoanUrgentFlag();
     ...
     * @return
     */
	public String backFrozenCodeByGrantSure(LoanInfo loaninfo) {
		Map<String, String> param = new HashMap<String, String>();
		param.put("applyId", loaninfo.getApplyId());
		LoanInfo loanInfo = loanInfoDao.findLoanLinkedContract(param);
		String urgentFlag = loanInfo.getLoanUrgentFlag();
		...
		Contract contract = contractDao.findByApplyId(loaninfo.getApplyId());
     ...
     * @return
     */
	public String cancelJxFlag(LoanInfo loaninfo) {
		Map<String, String> param = new HashMap<String, String>();
		param.put("applyId", loaninfo.getApplyId());
		LoanInfo loanInfo = loanInfoDao.findLoanLinkedContract(param);
		String urgentFlag = loanInfo.getLoanUrgentFlag();
        ...
        String code = "";
        //判断是不是取消的金信标识
        code =  loaninfo.getDictLoanStatus()+"-1"+urgentFlag + "-"+ frozenFlag + "-00";
        String channelFlag=contract.getChannelFlag();
        if (ChannelFlag.ZCJ.getCode().equals(channelFlag)) {
       	 code = code + "-05";
        }
     ...
     * @return
     */
	public String backGrantSureByJx(LoanInfo loaninfo) {
		Map<String, String> param = new HashMap<String, String>();
		param.put("applyId", loaninfo.getApplyId());
		LoanInfo loanInfo = loanInfoDao.findLoanLinkedContract(param);
		String urgentFlag = loanInfo.getLoanUrgentFlag();
     ...
     * @return
     */
	public String backContractCheckByJx(LoanInfo loaninfo) {
		Map<String, String> param = new HashMap<String, String>();
		param.put("applyId", loaninfo.getApplyId());
		LoanInfo loanInfo = loanInfoDao.findLoanLinkedContract(param);
		String urgentFlag = loanInfo.getLoanUrgentFlag();
     ...
     * @return
     */
	public String cancelJxByDiscard(LoanInfo loaninfo) {
		Map<String, String> param = new HashMap<String, String>();
		param.put("applyId", loaninfo.getApplyId());
		LoanInfo loanInfo = loanInfoDao.findLoanLinkedContract(param);
		String urgentFlag = loanInfo.getLoanUrgentFlag();
     ...
     * @return
     */
	public String sendGrantSureByAccount(LoanInfo loaninfo) {
		Map<String, String> param = new HashMap<String, String>();
		param.put("applyId", loaninfo.getApplyId());
		LoanInfo loanInfo = loanInfoDao.findLoanLinkedContract(param);
		String urgentFlag = loanInfo.getLoanUrgentFlag();
