...
/**
 * 非集中回款处理类
 * @Class Name UnCentralizedPaymentHandler
 * @author 张永生
 * @Create In 2016年5月21日
 */
@Component
public class UnCentralizedPaymentHandler extends DeductResultHandler {

	@Autowired
	public DeductUpdateDao deductUpdateDao;
	...
	public void updateDeductInfo(LoanDeductEntity deduct) {
		...
		// 蓝补历史更新
		//TODO payback.getPaybackBuleAmount()
