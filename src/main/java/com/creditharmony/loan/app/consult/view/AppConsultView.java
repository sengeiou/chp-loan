 ...
 * app客户咨询VIEW
 * 接收页面传递的参数
 * @Class Name AppCustomerView
 * @author fan
 * @Create In 2016年6月6日
 */
public class AppConsultView implements Serializable {
	
	private static final long serialVersionUID = -8482862836792337473L;
	
	private String  id; // 主键
	private String  customerId;  // 客户id(关联客户信息基础表)
	private String  financingId ;  // 客户经理id(关联组织机构表员工Id)
	private String  financingName; // 客户经理名称
	...
	private String  teamEmpName;  // 团队经理名称
	...
	public void setTeamEmpName(String teamEmpName) {
		this.teamEmpName = teamEmpName;
	}
