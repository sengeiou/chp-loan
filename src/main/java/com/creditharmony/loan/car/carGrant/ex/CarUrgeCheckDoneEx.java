...
public class CarUrgeCheckDoneEx extends DataEntity<CarUrgeCheckDoneEx> {
	// 关联类型,催收服务费
	...
	// 借款状态
	@ExcelField(title = "借款状态", type = 0, align = 2, sort = 60,dictType="jk_car_loan_status")
	...
	// 标识
	@ExcelField(title = "标识", type = 0, align = 2, sort = 160,dictType = "jk_car_throuth_flag")
