...
public class carContractUtils {
	...
	public static String dateToString(Date date, String patten) {
	 ...
	 /**
	    ...
	    * @return URL
	    */
	   public static String getLoanCarAllURL(String rptFileName,String enloanCode ,String  type,String contractVersion) {
		   String url = Global.getConfig("loan.carextend.file");// 合同车借公用地址
		   if(!"1.3".equals(contractVersion)){
			   url = Global.getConfig("loan.carextend.file_"+contractVersion.replace(".", "_"));
		   }
