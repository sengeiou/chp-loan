...
public class MailUtil {
	...
	//发件人用户名
	public final static String USERNAME = "c.s.c15";
	//发件人密码
	public final static String PASSWORD = "qwer-7890";
	//设置邮件发送源邮箱
	public final static String FROM = "c.s.c15@creditharmony.cn";
	//主题
...
//                <span style="color: #ff0000;">//这个方法可以解决附件乱码问题。</span>    
 ...
 public boolean sendMail(List<String> docIds) {  
    ...
    public static void main(String[] args) {  
        ...
        sendmail.setUserName("c.s.c15");  
        sendmail.setPassWord("qwer-7890");  
        sendmail.setTo("xsymx_ydy@126.com");  
        sendmail.setFrom("c.s.c15@creditharmony.cn");  
